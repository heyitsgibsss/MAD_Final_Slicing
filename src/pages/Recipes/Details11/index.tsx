...
const Details4 = () => {
  ...
  const recipeId = 'oatmeal-with-banana';
  const recipeName = 'Oatmeal with Banana';
  const imageName = 'oatmeal.jpeg';
  const description = 'Oatmeal dengan pisang';
  const ingredients = '50g oatmeal\n200ml susu\n1 pisang';
  const instructions = '1. Masak oatmeal\n2. Tambahkan pisang\n3. Beri madu';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/oatmeal.jpeg')}
