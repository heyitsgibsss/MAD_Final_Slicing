...
const Details4 = () => {
  ...
  const recipeId = 'spicy-ramen';
  const recipeName = 'Spicy Ramen';
  const imageName = 'ramen.jpeg';
  const description = 'Mie pedas meledak';
  const ingredients = '1 bungkus ramen pedas\n500ml air\n1 sdm sambal';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/ramen.jpeg')}
