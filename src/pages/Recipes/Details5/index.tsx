...
const Details4 = () => {
  ...
  const recipeId = 'comforting-chicken-soup';
  const recipeName = 'Comforting Chicken Soup';
  const imageName = 'chickensoup.jpeg';
  const description = 'Sup ayam hangat penenang';
  const ingredients =
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/chickensoup.jpeg')}
