...
const Details4 = () => {
  ...
  const recipeId = 'lavender-honey-milk';
  const recipeName = 'Lavender Honey Milk';
  const imageName = 'lavenderhoneymilk.jpeg';
  const description = 'Susu lavender madu';
  const ingredients = '300ml susu\n1 sdt lavender\n1 sdm madu';
  const instructions =
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/lavenderhoneymilk.jpeg')}
