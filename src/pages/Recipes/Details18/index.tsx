...
const Details4 = () => {
  ...
  const recipeId = 'hot-wings-extreme';
  const recipeName = 'Hot Wings Extreme';
  const imageName = 'hotwings.jpeg';
  const description = 'Sayap ayam super pedas';
  const ingredients = '10 sayap ayam\n5 sdm saus sambal';
  const instructions =
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/hotwings.jpeg')}
