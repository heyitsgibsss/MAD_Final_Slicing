...
const Details4 = () => {
  ...
  const recipeId = 'experimental-sushi-burrito';
  const recipeName = 'Experimental Sushi Burrito';
  const imageName = 'sushiburito.jpeg';
  const description = 'Sushi ala burrito';
  const ingredients = '1 lembar nori\n200g nasi sushi\n50g salmon';
  const instructions =
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/sushiburito.jpeg')}
