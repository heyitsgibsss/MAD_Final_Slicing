...
const Details4 = () => {
  ...
  const recipeId = 'hot-chocolate-marshmallow';
  const recipeName = 'Hot Chocolate with Marshmallow';
  const imageName = 'hotchoco.jpeg';
  const description = 'Cokelat hangat dengan marshmallow';
  const ingredients = '2 sdm bubuk cokelat\n200ml susu\n5 marshmallow';
  const instructions =
    '1. Panaskan susu\n2. Campur bubuk cokelat\n3. Tambahkan marshmallow';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/hotchoco.jpeg')}
