...
const Details4 = () => {
  ...
  const recipeId = 'avocado-toast';
  const recipeName = 'Avocado Toast';
  const imageName = 'avocadotoast.jpeg';
  const description = 'Roti panggang dengan alpukat';
  const ingredients = '1 alpukat\n2 roti gandum\n1 sdt lemon juice';
  const instructions =
    '1. Panggang roti\n2. Haluskan alpukat\n3. Oleskan pada roti';
