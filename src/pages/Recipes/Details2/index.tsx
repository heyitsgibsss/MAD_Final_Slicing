...
const Details2 = () => {
  ...
  const recipeId = 'rainbows-smoothies';
  const recipeName = 'Rainbow Smoothie Bowl';
  const imageName = 'rainbowsmoothies.jpeg';
  const description = 'Bowl warna-warni penuh nutrisi';
  const ingredients =
    '1 pisang\n100g yogurt\n1/2 mangga\n1 sdm chiaseed\n Topping buah beragam';
  const instructions =
    '1. Blender pisang, yogurt dan mangga\n2. Tuang ke bowl\n3. Tambahkan topping buah\n4. Taburi chia seed';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/rainbowsmoothies.jpeg')}
