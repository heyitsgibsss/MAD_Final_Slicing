...
const Details4 = () => {
  ...
  const recipeId = 'creamy-mushroom-risotto';
  const recipeName = 'Creamy Mushroom Risotto';
  const imageName = 'mushroomrisotto.jpeg';
  const description = 'Nasi krim dengan jamur';
  const ingredients = '200g beras risotto\n100g jamur\n1 liter kaldu ayam';
  const instructions =
    '1. Tumis jamur\n2. Masak beras dengan kaldu\n3. Aduk hingga kental';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/mushroomrisotto.jpeg')}
