...
const Details4 = () => {
  ...
  const recipeId = 'colorful-fruit-skewers';
  const recipeName = 'Colorful Fruit Skewers';
  const imageName = 'fruitskewers.jpeg';
  const description = 'Tusuk buah warna-warni';
  const ingredients = '1/2 semangka\n1 buah nanas\n10 anggur';
  const instructions =
    '1. Potong buah\n2. Tusuk bergantian\n3. Susun di piring';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/fruitskewers.jpeg')}
