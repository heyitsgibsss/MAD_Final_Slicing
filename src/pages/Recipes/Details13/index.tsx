...
const Details4 = () => {
  ...
  const recipeId = 'rainbow-spring-rolls';
  const recipeName = 'Rainbow Spring Rolls';
  const imageName = 'springrolls.jpeg';
  const description = 'Lumpia warna-warni';
  const ingredients =
    '10 kulit lumpia\n1 wortel (iris korek)\n1/2 mentimun (iris)';
  const instructions =
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/springrolls.jpeg')}
