...
const Details4 = () => {
  ...
  const recipeId = 'diy-pizza';
  const recipeName = 'DIY Pizza';
  const imageName = 'pizza.jpeg';
  const description = 'Pizza kreasi sendiri';
  const ingredients = '1 dasar pizza\n50ml saus tomat\nTopping pilihan';
  const instructions =
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/pizza.jpeg')}
