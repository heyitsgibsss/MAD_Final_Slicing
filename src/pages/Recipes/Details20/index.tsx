...
const Details4 = () => {
  ...
  const recipeId = 'hellfire-noodles';
  const recipeName = 'Hellfire Noodles';
  const imageName = 'hellfirenoodles.jpeg';
  const description = 'Mie api neraka';
  const ingredients = '200g mie telur\n3 sdm sambal rawit';
  const instructions = '1. Rebus mie\n2. Campur dengan sambal\n3. Aduk rata';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <Image
          source={require('../../../assets/recipes/hellfirenoodles.jpeg')}
